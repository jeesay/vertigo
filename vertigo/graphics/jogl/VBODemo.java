...
public class VBODemo implements GLEventListener, KeyListener {
    ...
    // ============================================================================================
    /**
     * Class that provides infos and a boolean flag that can be switched on and
     * off by the user.
     *
     * @author Stefan Gaffga
     */
    ...
    /**
     * The factor everything that is time controlled is scaled by to get the
     * same speed at all FPS values.
     */
    ...
    /**
     * This is called once per frame and updates the FPS value and shows it in
