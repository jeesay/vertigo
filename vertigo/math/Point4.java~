 ...
 */
    ...
    /**
      ...
      */
    public Point4(float p[]) {
	super(p);
    }

    /**
      * Constructs and initializes a Point4 from the specified Point4.
      * @param p1 the Point4 containing the initialization x y z w data
      */
    public Point4(Point4 p1) {
	super(p1);
    }
    ...
    /**
      * Constructs and initializes a Point4 from the specified Tuple4f.
      * @param t1 the Tuple4f containing the initialization x y z w data
      */
    public Point4(Tuple4 t1) {
	super(t1);
    }
    ...
    /**
      ...
      */
    public final float distanceSquared(Point4 p1) {
	double dx = x - p1.x;
	double dy = y - p1.y;
	double dz = z - p1.z;
	double dw = w - p1.w;
    ...
    /**
      ...
      */
    public final float distance(Point4 p1) {
    ...
    /**
      ...
      * @return L-1 distance
      */
    public final float distanceL1(Point4 p1) {
    ...
    /**
      ...
      */
    public final float distanceLinf(Point4 p1) {
