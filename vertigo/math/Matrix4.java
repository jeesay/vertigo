 ...
 */
   ...
   public FloatBuffer toBuffer() {
     ...
     * @return the array of float representation
     */ 
   public FloatBuffer toColumnBuffer() {
     float[] buf = {m00,m10,m20,m30,m01,m11,m21,m31,m02,m12,m22,m32,m03,m13,m23,m33};
     FloatBuffer fbuf = BufferTools.newFloatBuffer(16);
     fbuf.put(buf);
     fbuf.rewind();     
     return fbuf;
    ...
    /**
     * Sets the specified row of this Matrix4 to the four values provided.
     * @param row  the row number to be modified (zero indexed)
    ...
    /**
     * Sets the specified row of this Matrix4 to the Vector provided.
     * @param row the row number to be modified (zero indexed)
    ...
    /**
      * Sets the specified column of this Matrix4 to the four values provided.
      * @param  column the column number to be modified (zero indexed)
    ...
    /**
      * Sets the specified column of this Matrix4 to the vector provided.
      * @param column the column number to be modified (zero indexed)
     ...
     */
    public final void add(Matrix4 m1) {
     ...
     * @param m1 the other matrix
     */
    public final void sub(Matrix4 m1) {
	m00 -= m1.m00; m01 -= m1.m01; m02 -= m1.m02; m03 -= m1.m03;
	m10 -= m1.m10; m11 -= m1.m11; m12 -= m1.m12; m13 -= m1.m13;
	m20 -= m1.m20; m21 -= m1.m21; m22 -= m1.m22; m23 -= m1.m23;
	m30 -= m1.m30; m31 -= m1.m31; m32 -= m1.m32; m33 -= m1.m33;
  ...
  /**
    ...
    */
    ...
    /**
      ...
      */
    public final void mulTransposeBoth(Matrix4 m1, Matrix4 m2) {
	mul(m2, m1);
	transpose();
    }
    ...
    /**
      ...
      * @param m2 The matrix on the right hand side of the multiplication
      */
    public final void mulTransposeLeft(Matrix4 m1, Matrix4 m2) {
	// alias-safe way.
	set(
    ...
    /**
      * Returns true if the Object o1 is of type Matrix4 and all of the data
      * members of t1 are equal to the corresponding data members in this
      * Matrix4.
      * @param o1 the object with which the comparison is made.
      */
    public boolean equals(Object o1) {
	return o1 != null && (o1 instanceof Matrix4) && equals((Matrix4)o1);
    }
    ...
    /**
      ...
      * The other elements are unchanged.
      */
    private void setRotationScale(Matrix4 m1) {
	m00 = m1.m00; m01 = m1.m01; m02 = m1.m02;
	m10 = m1.m10; m11 = m1.m11; m12 = m1.m12;
	m20 = m1.m20; m21 = m1.m21; m22 = m1.m22;
    }
