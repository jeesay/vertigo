 ...
 * Java3D 1.2 support
 * AxisAngle4(Vector3f axis, float angle) constructor and
 ...
 */
    ...
    /**
      ...
      */
    public AxisAngle4(float x, float y, float z, float angle) {
	set(x, y, z, angle);
    }
    ...
    /**
      ...
      */
    public AxisAngle4(float a[]) {
	set(a);
    }

    /**
      * Constructs and initializes a AxisAngle4 from the specified AxisAngle4.
      * @param a1 the AxisAngle4 containing the initialization x y z angle data
      */
    public AxisAngle4(AxisAngle4 a1) {
	set(a1);
    }
    ...
    /**
     * Constructs and initializes an AxisAngle4 from the specified axis
     * and angle.
     *
     * @param axis the axis
     * @param angle the angle
     * @since Java 3D 1.2
     */
    public AxisAngle4(Vector3 axis, float angle) {
        x = axis.x;
        y = axis.y;
        z = axis.z;
        this.angle = angle;
    ...
    /**
     * Sets the value of this AxisAngle4 to the specified axis and
     * angle.
     * @param axis the axis
     * @param angle the angle
     * @since Java 3D 1.2
    ...
    /**
      ...
      */
    public boolean equals(AxisAngle4 a1) {
	return a1 != null && x == a1.x && y == a1.y && z == a1.z && angle == a1.angle;
    }

    /**
      * Returns true if the Object o1 is of type AxisAngle4 and all of the data
      * members of o1 are equal to the corresponding data members in this
      * AxisAngle4.
      * @param o1 the object with which the comparison is made.
      */
    public boolean equals(Object o1) {
	return o1 != null && (o1 instanceof AxisAngle4) && equals((AxisAngle4)o1);
    }
    ...
    /**
      ...
      */
    public boolean epsilonEquals(AxisAngle4 a1, float epsilon) {
