...
/**
  ...
  */
public class Vector3 extends Tuple3 implements Serializable {
/*
 * $Log: Vector3.java,v $
 ...
 * normalize(Vector3d) -> normalize(Vector3) suggested by leonvs@iaehv.nl
 *
 ...
 */
    ...
    /**
      * Constructs and initializes a Vector3 from the specified Vector3.
      * @param v1 the Vector3 containing the initialization x y z data
      */
    ...
    /**
      * Constructs and initializes a Vector3 from the specified Tuple3.
      * @param t1 the Tuple3 containing the initialization x y z data
      */
    public Vector3(Tuple3 t1) {
	super(t1);
    }
