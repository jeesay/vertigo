 ...
 * ** Matrix#set(float []) m22 should be m[ 8] but was m[ 9]
 ...
 */
    ...
    /**
      * Constructs and initializes a Matrix from the specified nine values.
    ...
    /**
      * Constructs and initializes a Matrix from the specified 9
  ...
  /**
    ...
    */
    ...
    /**
      * Sets the value of this matrix to the float value of the Matrix
      * argument.
    ...
    */
    ...
    /**
      * Sets the values in this Matrix equal to the row-major array parameter
	...
	float s = (float) Math.pow(determinant(), -1.0/3.0);
	mul(s);
    }
    ...
    /**
      * Sets the value of this matrix equal to the negation of of the Matrix
      * parameter.
      * @param m1 The source matrix
      */
    ...
    /**
     * Transform the vector vec using this Matrix and place the
